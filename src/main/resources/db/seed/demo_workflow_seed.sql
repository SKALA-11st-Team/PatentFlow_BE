...
WITH demo_reviews (
    ...
    VALUES
        ...
        ('PAT-2026-0073', 'BUSINESS_RESPONSE_RECEIVED', 'SALES_CANDIDATE',
         '해외 권리 유지 비용 대비 내부 활용 계획이 낮아 매각 후보 검토가 필요합니다.', 52,
        ...
        ('PAT-2026-0082', 'LEGAL_ACTION_RECORDED', 'SALES_CANDIDATE',
         '내부 활용 가능성은 낮지만 외부 이전 가능성이 있어 매각 후보로 관리합니다.', 57,
         ...
         'ABANDON', '현 사업 전략과 직접 연결성이 낮아 포기 의견이나 외부 이전 가능성은 있습니다.',
         TIMESTAMP WITH TIME ZONE '2026-05-14 15:40:00+09',
         'SOLD', '포기 의견을 반영하되 외부 수요 가능성이 있어 매각 후보로 처리합니다.',
...
INSERT INTO business_submissions (
    ...
    (
        ...
        7,
        -3,
        '[{"itemId":"TECH_COMPLETENESS","score":3,"memo":"기술 자체는 활용 가능성이 있습니다."},{"itemId":"TECH_ORIGINALITY","score":2,"memo":"국내 권리로도 방어 가능합니다."},{"itemId":"MARKETABILITY","score":2,"memo":"중국 권리 활용 계획은 낮습니다."},{"itemId":"EXPECTED_EFFECT","score":3,"memo":"매각 가능성은 검토할 수 있습니다."}]'
    ),
    (
    ...
    (
        ...
        1,
        'ABANDON',
        '현 사업 전략과 직접 연결성이 낮아 포기 의견이나 외부 이전 가능성은 있습니다.',
        '사업기획 담당자',
        TIMESTAMP WITH TIME ZONE '2026-05-14 15:40:00+09',
        TIMESTAMP WITH TIME ZONE '2026-05-14 09:00:00+09',
        'SALES_CANDIDATE',
